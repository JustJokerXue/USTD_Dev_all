...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CourseMessage',
            fields=[
                ('cid', models.IntegerField(default=0, primary_key=True, serialize=False, verbose_name='课程号')),
                ('course', models.CharField(default='', max_length=200, null=True, verbose_name='课程')),
                ('banji', models.CharField(default='2020级', max_length=200, verbose_name='班级')),
                ('teacher', models.CharField(default='', max_length=200, null=True, verbose_name='任课教师')),
                ('credits', models.FloatField(default=0, null=True, verbose_name='学分')),
            ],
            options={
                'verbose_name': '课程',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leibie', models.CharField(choices=[('专业技术', '专业技术'), ('创新创业', '创新创业'), ('管理实践', '管理实践'), ('综合发展', '综合发展')], default='专业技术', max_length=200, verbose_name='材料类别')),
                ...
                ('zhuangtai', models.CharField(choices=[('T', '通过'), ('F', '不通过'), ('D', '待审核')], default='D', max_length=200, verbose_name='状态')),
            ],
            options={
                'verbose_name': '审核',
        ...
        migrations.AddConstraint(
            model_name='weight',
            constraint=models.CheckConstraint(check=models.Q(('zyweight__gte', 0), ('zyweight__lte', 1)), name='zyweight'),
        ),
        migrations.AddConstraint(
            model_name='weight',
            constraint=models.CheckConstraint(check=models.Q(('cxweight__gte', 0), ('cxweight__lte', 1)), name='cxweight'),
        ),
        migrations.AddConstraint(
            model_name='weight',
            constraint=models.CheckConstraint(check=models.Q(('zsweight__gte', 0), ('zsweight__lte', 1)), name='zsweight'),
        ),
        migrations.AddConstraint(
            model_name='weight',
            constraint=models.CheckConstraint(check=models.Q(('glweight__gte', 0), ('glweight__lte', 1)), name='glweight'),
        ),
        migrations.AddConstraint(
            model_name='weight',
            constraint=models.CheckConstraint(check=models.Q(('zhweight__gte', 0), ('zhweight__lte', 1)), name='zhweight'),
        ),
        migrations.AddConstraint(
            model_name='shenhe',
        ...
        migrations.AddConstraint(
            model_name='score',
            constraint=models.CheckConstraint(check=models.Q(('overallgrade__gte', 0), ('overallgrade__lte', 100)), name='overallgrade'),
        ),
        migrations.AddConstraint(
            model_name='overallscore',
            constraint=models.CheckConstraint(check=models.Q(('total_score__gte', 0), ('total_score__lte', 100)), name='overall_score_total_score'),
        ),
        migrations.AddConstraint(
            model_name='manage',
            constraint=models.CheckConstraint(check=models.Q(('total_score__gte', 0), ('total_score__lte', 100)), name='manage_total_score'),
        ),
        migrations.AddConstraint(
            model_name='majortechnology',
            constraint=models.CheckConstraint(check=models.Q(('total_score__gte', 0), ('total_score__lte', 100)), name='major_technology_total_score'),
        ),
        migrations.AddConstraint(
            model_name='learning',
            constraint=models.CheckConstraint(check=models.Q(('total_score__gte', 0), ('total_score__lte', 100)), name='learning_total_score'),
        ),
        migrations.AddConstraint(
            model_name='innovation',
            constraint=models.CheckConstraint(check=models.Q(('total_score__gte', 0), ('total_score__lte', 100)), name='innovation_total_score'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddField(
            ...
            name='grad_req_id',
            field=models.ForeignKey(blank=True, db_column='stu_gradReq_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='USTD_App1.graduationrequirement', verbose_name='学业要求id'),
        ),
        migrations.AddConstraint(
            model_name='course',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('total_score__gte', 0), ('total_score__lte', 100)), name='dev_total_score'),
        ),
        migrations.AddConstraint(
            model_name='early_warning',
            constraint=models.CheckConstraint(check=models.Q(('minimum__gte', 0), ('minimum__lte', 170)), name='minimum'),
        ),
        migrations.AddConstraint(
            model_name='early_warning',
            constraint=models.CheckConstraint(check=models.Q(('compulsory__gte', 0), ('compulsory__lte', 100)), name='compulsory'),
        ),
        migrations.AddConstraint(
            model_name='early_warning',
            constraint=models.CheckConstraint(check=models.Q(('elective__gte', 0), ('elective__lte', 100)), name='elective'),
        ),
        migrations.AddConstraint(
            model_name='early_warning',
            constraint=models.CheckConstraint(check=models.Q(('physical__gte', 0), ('physical__lte', 100)), name='physical'),
        ),
        migrations.AddConstraint(
            model_name='early_warning',
        ...
        migrations.AddConstraint(
            model_name='early_warning',
            constraint=models.CheckConstraint(check=models.Q(('mandarin__gte', 0), ('mandarin__lte', 100)), name='mandarin'),
        ),
    ]
